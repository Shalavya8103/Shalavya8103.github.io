...
export default function Speaking() {
  return (
    <SimpleLayout
      title="Contact me."
      intro="Feel free to contact me via LinkedIn or email (DMs are open). I'll respond within a day. If you have an interesting project or collaboration opportunity, I'd love to hear from you."
    >
